...
export const Github = ({height,width,color}) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
...
export const Twitter = ({height,width,color}) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
...
export const YinYang = ({height,width,color}) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
...
export const LinkedIn = ({height,width,color}) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
    ...
    >
      <path
        fill={color || '#000'} // Default fill color if not provided
        d="M21.3 0H2.7C1.2 0 0 1.2 0 2.7v18.6C0 22.8 1.2 24 2.7 24h18.6c1.5 0 2.7-1.2 2.7-2.7V2.7C24 1.2 22.8 0 21.3 0zM7.9 19.1H4.7V9.2h3.2v9.9zM6.3 8c-1 0-1.7-.7-1.7-1.6S5.3 4.8 6.3 4.8c1 0 1.7.7 1.7 1.6s-.7 1.6-1.7 1.6zM19.1 19.1h-3.2v-5.2c0-1.2-.4-2-1.4-2-1.4 0-2 1.2-2 3.1v4.1h-3.2V9.2h3.1v1.6h.1c.4-.8 1.3-1.7 2.7-1.7 2 0 3.5 1.3 3.5 4.2v5.8z"
      />
    </svg>
  );
};
